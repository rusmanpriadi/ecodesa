...
export function DataTablePagination({
  ...
  return (
    <div className="flex flex-col sm:flex-row items-center justify-between px-2 w-full overflow-x-auto">
      ...
      <div className="flex items-center space-x-6 lg:space-x-8">
        <div className="flex items-center space-x-2">
          <p className=" font-medium text-xs hidden md:block">Rows per page</p>
          <Select
